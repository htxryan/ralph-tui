...
- **task_id**: The task identifier (required) - corresponds to `.ai-docs/plans/<task_id>/task.md`
...
- Input:  .ai-docs/plans/<task-id>/task.md (required - defines the research assignment)
- Output: .ai-docs/plans/<task-id>/research.md (generated by this command)
```
...
3. **Respond with confirmation**:
   ...
   Output: .ai-docs/plans/<task_id>/research.md
...
5. **Gather metadata for the research document:**
   ...
   - **Output path**: `.ai-docs/plans/<task_id>/research.md`

6. **Generate research document:**
   - Use the metadata gathered in step 5
   - **CRITICAL**: Write to `.ai-docs/plans/<task_id>/research.md`
...
8. **Present findings:**
   ...
   - Confirm the research was saved:
     ```
     Research saved to: .ai-docs/plans/<task_id>/research.md
...
This project uses `.ai-docs/plans/` for task-based workflows:
...
- **Output location**: Always write to `.ai-docs/plans/<task_id>/research.md`
